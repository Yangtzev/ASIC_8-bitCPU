...
// SDF
  ...
  initial begin $sdf_annotate("control_pad.sdf", c1, "MAXIMUM");end
  ...
  initial
    begin
      ...
      for ( j=0; j<=127; j=j+1 )
        @ ( negedge clk )
          begin
            $display("%t %b  %b  %b     %b      %b     %b      %b    %b      %b   %b    %b",
            $time,rd,wr,ld_ir,ld_ac,ld_pc,inc_pc,halt,data_e,sel,opcode,zero ) ;
